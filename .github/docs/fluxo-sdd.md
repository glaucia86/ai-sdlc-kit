...
| Projeto que usou Discovery e agora quer implementar um épico | **Fluxo A** — a partir de `/epic-init` |
...
| Situação | Comando |
|---|---|
| Incidente ou alerta observado em produção | `/ops-triage` |

### Como funciona

1. Executar `/ops-triage`
...
> **Nota:** `/ops-triage` não executa ações em produção. Ele propõe, documenta e fecha o ciclo de aprendizado.
